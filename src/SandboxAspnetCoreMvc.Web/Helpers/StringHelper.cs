...
public static class StringHelper
{
    ...
    public static String ReadTextFile(Microsoft.AspNetCore.Hosting.IHostingEnvironment env, string filePath, bool isReplaceCarraige)
    {
        string content = String.Empty;
        string rootPath = env.WebRootPath;
        string fullPath = System.IO.Path.Combine(rootPath, filePath);

        // Create StreamReader object.
        System.IO.Stream file = new System.IO.FileStream(fullPath, System.IO.FileMode.Open, System.IO.FileAccess.Read, System.IO.FileShare.ReadWrite);
